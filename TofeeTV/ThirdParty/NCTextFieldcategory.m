...
- (CGRect)textRectForBounds:(CGRect)bounds {
    ...
    return CGRectMake(xpos, 2, bounds.size.width, bounds.size.height);
}
...
-(void)addleftImage{
    ...
    UIView *paddingView = [[UIView alloc] initWithFrame:CGRectMake(0, 20, 60, self.frame.size.height)];
    UIImageView *theimg = [[UIImageView alloc] initWithImage:_leftimage];
    
    theimg.frame = CGRectMake(0, 0, 40, self.frame.size.height);
    
    theimg.contentMode = UIViewContentModeCenter;
...
-(void)showErrorPlaceHolder{
    ...
    if (self.errorText != nil && ![self.errorText isEqualToString:@""]) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
          ...
          //  self.layer.borderColor = _errorLineColor.CGColor;
