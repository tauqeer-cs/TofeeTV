...
{   
    ...
    [self.otherView setFrame:CGRectMake(5, -4, self.frame.size.height, self.frame.size.height)];
    
    if (IS_IPHONE_6) {
        
        
        
        [self.otherView setFrame:CGRectMake(2, -3.5 , self.frame.size.height-2, self.frame.size.height-2)];
    ...
    else if(IS_IPHONE_5)
    {
        ...
        [self.otherView setFrame:CGRectMake(1, -2, self.frame.size.width-2, self.frame.size.width-2)];
        
        
        
    }
    self.otherView.layer.cornerRadius = 10;
...
- (void)configureAppearance
{
    ...
    if (self.dateIsToday)
    {
        ...
        self.titleLabel.textColor = [UIColor colorWithRed:0.9647058824 green:0.5215686275 blue:0.6352941176 alpha:1.0];
        
        //
       self.otherView.layer.borderColor = [UIColor colorWithRed:0.9647058824 green:0.5215686275 blue:0.6352941176 alpha:1.0].CGColor;
        self.otherView.layer.borderWidth = 1.0;
    ...
    if (![textColor isEqual:_titleLabel.textColor]) {
        ...
        self.otherView.layer.borderWidth = 0.0;
