...
- (BOOL) isEqualToDateIgnoringTime: (NSDate *) aDate bDate:(NSDate *)bDate
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:componentFlags fromDate:bDate];
...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    BOOL wasAnythingTheir = NO;
    
    
    for (NSDate *currentDate in _selectedDates)
    {
        
        
        
        
        if([self isEqualToDateIgnoringTime:currentDate bDate:date]){
            


            wasAnythingTheir = YES;
    ...
    if (wasAnythingTheir) {
        ...
        cell.otherView.backgroundColor = [UIColor colorWithRed:0.9647058824 green:0.5215686275 blue:0.6352941176 alpha:1.0];
