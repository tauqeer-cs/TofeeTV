...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = DefaultRed;
        ...
        self.confirmButtonBackgroundColor = DefaultRed;
        ...
        self.cancelButtonBackgroundColor = [UIColor colorWithRed:204.0/255 green:204.0/255 blue:204.0/255 alpha:1];
...
- (UIView *)buildFooterView{
    ...
    if ((leftRect.size.width > 0) && (leftRect.size.height > 0)) {
        ...
        cancelButton.titleLabel.font = [UIFont fontWithName:@"MavenProMedium" size:16];
    ...
    if ((rightRect.size.width > 0) && (rightRect.size.height > 0)) {
        ...
        confirmButton.titleLabel.font = [UIFont fontWithName:@"MavenProMedium" size:16];
...
- (UIView *)buildHeaderView {
    ...
    NSDictionary *dict = @{
                           ...
                           NSFontAttributeName: [UIFont fontWithName:@"Roboto-Regular" size:16]
                           };
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.font = [UIFont fontWithName:@"MavenProRegular" size:15];
